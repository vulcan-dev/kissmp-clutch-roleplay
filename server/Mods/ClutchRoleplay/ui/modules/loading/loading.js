...
.controller('LoadingController', ['logger', '$scope', 'ControlsUtils', 'Hints', 'Utils',
  function (logger, $scope, ControlsUtils, Hints, Utils) {
  ...
  bngApi.engineLua(`dirContent("/ui/modules/loading/${beamng.product}/")`, (files) => {
