...
local modules = {
    cl_tab_moderation = require('addons.vulcan_script.client_lua.cl_tab_moderation'),
    cl_tab_debug = require('addons.vulcan_script.client_lua.cl_tab_debug'),
    cl_tab_players = require('addons.vulcan_script.client_lua.cl_tab_players'),
